"""
pages/3_Provincia.py — Wrapper para Dashboard Provincia
Lee y ejecuta Dashboard Provincia.py sin modificarlo.
...
# ─── VERIFICAR PERMISO ────────────────────────────────────────────────────────
if not auth.has_access("provincia"):
...
_dash_path = os.path.join(_ROOT, "Dashboard Provincia.py")
